...
//     try {
//       // Convert dropdown string values to numbers or null for the backend
//       const payload = {
//         ...form,
//         selected_vertical: form.selected_vertical ? parseInt(form.selected_vertical) : null,
//         selected_region: form.selected_region ? parseInt(form.selected_region) : null,
//       };

//       await fetch(`${API_BASE}/campaign-workspace/generate_content/`, {
//         method: 'POST',
...
//           className="p-2 bg-white border border-slate-200 rounded-xl hover:bg-slate-100 transition-colors text-slate-600"
//         >
//           <ArrowLeft size={20} />
//         </button>
//         <div>
//           <h2 className="text-3xl font-bold text-slate-800">Generate New Campaign</h2>
//           <p className="text-slate-500 mt-1">Fill in the details below to let AI draft your campaign.</p>
//         </div>
//       </header>

//       <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm max-w-4xl">
//         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          
//           <div className="space-y-1">
//             <label className="text-sm font-bold text-slate-700">Workspace Name *</label>
//             <input
//               className="w-full p-3 border border-slate-200 rounded-xl bg-slate-50 focus:bg-white transition-colors outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500"
//               placeholder="e.g., Q3 Tech Follow-up"
//               value={form.name}
...
//             <input
//               className="w-full p-3 border border-slate-200 rounded-xl bg-slate-50 focus:bg-white transition-colors outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500"
//               placeholder="e.g., Discount Offer, Feature Update"
...
//             <select
//               className="w-full p-3 border border-slate-200 rounded-xl bg-slate-50 focus:bg-white transition-colors outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500"
//               value={form.selected_channel}
//               onChange={e => setForm({ ...form, selected_channel: e.target.value })}
//             >
...
//             <label className="text-sm font-bold text-slate-700">Target Audience Description</label>
//             <textarea
//               className="w-full p-3 border border-slate-200 rounded-xl bg-slate-50 focus:bg-white transition-colors outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 min-h-[100px]"
//               placeholder="Who are you targeting? (e.g., IT Directors in Mid-sized logistics companies)"
...
//           <div className="space-y-1 md:col-span-2">
//             <label className="text-sm font-bold text-slate-700">AI Prompt Instructions</label>
//             <textarea
//               className="w-full p-3 border border-slate-200 rounded-xl bg-slate-50 focus:bg-white transition-colors outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 min-h-[100px]"
//               placeholder="Any specific instructions for the AI? (e.g., Keep it under 50 words, use an urgent tone)"
//               value={form.prompt}
...
//               isGenerating ? 'bg-emerald-400 text-white cursor-not-allowed' : 'bg-emerald-600 hover:bg-emerald-700 text-white'
//             }`}
//           >
//             {isGenerating ? (
//               <>Generating AI Draft...</>
